...
void main() {
  testWidgets('pagina dedicada mostra reviews sem esconder o CTA', (
    ...
    _expectCtaAboveReviewSummary(tester);
  ...
  testWidgets('pagina dedicada coloca CTA antes do resumo em mobile', (
    WidgetTester tester,
  ) async {
...
void _expectCtaAboveReviewSummary(WidgetTester tester) {
  final ctaTop = tester
      .getTopLeft(find.byKey(const Key('start-review-button')))
      .dy;
  final summaryTop = tester
      .getTopLeft(find.byKey(const Key('place-review-summary-content')))
      .dy;

  expect(ctaTop, lessThan(summaryTop));
}
